...
alias ..="cd .."
alias ...="cd ../.."
alias b="setsid brave --force-device-scale-factor=1.25 > /dev/null 2>&1"
alias c="clear"
...
alias gcaan="git commit --amend --allow-empty --no-edit"
...
alias ddo="d docker"
alias ddbt="d docker build -t"
alias ddc="d docker cp"
alias ddp="d docker ps"
alias ddpa="d docker ps -a"
alias ddi="d docker images"
alias ddir="ddi rm"
alias ddcr="d docker container rm"
alias ddcra="ddcr \$(d docker ps -aq)"
alias ddrrn="doas -u $USER docker run --rm --name"
alias ddspa="d docker system prune -a"

#  ╔════════════════════════════════════════
#  ║                    GPG
#  ╚════════════════════════════════════════
alias gbc="gpg --batch -c"
